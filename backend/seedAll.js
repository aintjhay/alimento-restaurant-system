...
const completeMenu = [
  ...
  { name: 'CRISPY CHIX', description: 'Chicken sandwich', price: 170, category: 'Sandwiches', image: 'CrispyChix.jpg', preparationTime: 15, tags: ['chicken', 'popular'], displayOrder: 19 },
  { name: 'CHORI CHEESEBURGER', description: 'Chorizo burger', price: 180, category: 'Sandwiches', image: 'Choricheeseburger.jpg', preparationTime: 15, tags: ['chorizo', 'burger'], displayOrder: 20 },
  { name: 'BBQ CHEESEBURGER', description: 'BBQ burger', price: 190, category: 'Sandwiches', image: '', preparationTime: 15, tags: ['burger', 'bbq'], displayOrder: 21 },
  ...
  { name: 'CHICKEN WINGS', description: 'Chicken wings', price: 260, category: 'Sides', image: 'BuffaloWings12s(2).jpg', preparationTime: 20, tags: ['chicken', 'popular'], displayOrder: 24 },
  ...
  { name: 'AMERICANO', description: 'Black coffee', price: 70, category: 'Coffee', image: '', preparationTime: 5, tags: ['coffee', 'classic'], displayOrder: 33 },
  { name: 'CAFE LATTE', description: 'Coffee latte', price: 100, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'milk'], displayOrder: 34 },
  { name: 'CAFE MOCHA', description: 'Mocha coffee', price: 100, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'chocolate'], displayOrder: 35 },
  { name: 'VANILLA LATTE', description: 'Vanilla latte', price: 105, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'vanilla'], displayOrder: 36 },
  { name: 'SPANISH LATTE', description: 'Spanish latte', price: 105, category: 'Coffee', image: 'SpanishLatte.jpg', preparationTime: 7, tags: ['coffee', 'sweet'], displayOrder: 37 },
  { name: 'CARAMEL LATTE', description: 'Caramel latte', price: 105, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'caramel'], displayOrder: 38 },
  { name: 'HAZELNUT LATTE', description: 'Hazelnut latte', price: 105, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'nutty'], displayOrder: 39 },
  { name: 'SALTED LATTE', description: 'Salted latte', price: 105, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'salted'], displayOrder: 40 },
  { name: 'SALTED CARAMEL LATTE', description: 'Salted caramel latte', price: 110, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'caramel'], displayOrder: 41 },
  { name: 'COCO-FREE (COCONUT MILK LATTE)', description: 'Coconut latte', price: 110, category: 'Coffee', image: '', preparationTime: 7, tags: ['coffee', 'vegan'], displayOrder: 42 },
  { name: 'ALIMENTO SUNRISE', description: 'Sunrise cooler', price: 140, category: 'Coolers', image: '', preparationTime: 5, tags: ['refreshing', 'popular'], displayOrder: 43 },
  { name: 'ALIMENTO CUCUMBER LEMONADE', description: 'Cucumber lemonade', price: 140, category: 'Coolers', image: '', preparationTime: 5, tags: ['refreshing', 'healthy'], displayOrder: 44 },
  { name: 'ALIMENTO ICED TEA', description: 'Iced tea', price: 140, category: 'Coolers', image: '', preparationTime: 5, tags: ['refreshing', 'tea'], displayOrder: 45 },
