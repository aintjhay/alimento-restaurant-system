...
const completeMenu = [
  ...
  { name: 'AMERICANO', description: 'Black coffee', price: 70, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 5, tags: ['coffee', 'classic'], displayOrder: 33, modifiers: [{ name: 'Temperature', required: true, options: [{ name: 'Hot', price: 60 }, { name: 'Cold', price: 70 }] }], addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'CAFE LATTE', description: 'Coffee latte', price: 100, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'milk'], displayOrder: 34, modifiers: [{ name: 'Temperature', required: true, options: [{ name: 'Hot', price: 90 }, { name: 'Cold', price: 100 }] }], addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'CAFE MOCHA', description: 'Mocha coffee', price: 100, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'chocolate'], displayOrder: 35, addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'VANILLA LATTE', description: 'Vanilla latte', price: 105, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'vanilla'], displayOrder: 36, addons: [{ name: 'Add Double Shot', price: 25 }] },
  ...
  { name: 'CARAMEL LATTE', description: 'Caramel latte', price: 105, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'caramel'], displayOrder: 38, addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'HAZELNUT LATTE', description: 'Hazelnut latte', price: 105, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'nutty'], displayOrder: 39, addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'SALTED LATTE', description: 'Salted latte', price: 105, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'salted'], displayOrder: 40, addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'SALTED CARAMEL LATTE', description: 'Salted caramel latte', price: 110, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'caramel'], displayOrder: 41, addons: [{ name: 'Add Double Shot', price: 25 }] },
  { name: 'COCO-FREE (COCONUT MILK LATTE)', description: 'Coconut latte', price: 110, category: 'Coffee', image: 'Coffee.jpg',, preparationTime: 7, tags: ['coffee', 'vegan'], displayOrder: 42, addons: [{ name: 'Add Double Shot', price: 25 }] },
