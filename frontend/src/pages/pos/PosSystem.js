...
function PosSystem() {
  ...
  const sampleMenu = [
    ...
    { name: "CAFE MOCHA", description: "Chocolate-flavored latte", price: 100, category: "Coffee", image: "Coffee.jpg", preparationTime: 7, tags: ["coffee", "chocolate"], modifiers: [], addons: [{ name: "Add Double Shot", price: 25 }] },
    { name: "VANILLA LATTE", description: "Latte with vanilla flavor", price: 105, category: "Coffee", image: "Coffee.jpg", preparationTime: 7, tags: ["coffee", "vanilla"], modifiers: [], addons: [{ name: "Add Double Shot", price: 25 }] },
    ...
    { name: "CARAMEL LATTE", description: "Latte with caramel flavor", price: 105, category: "Coffee", image: "Coffee.jpg", preparationTime: 7, tags: ["coffee", "caramel"], modifiers: [], addons: [{ name: "Add Double Shot", price: 25 }] },
    { name: "HAZELNUT LATTE", description: "Latte with hazelnut flavor", price: 105, category: "Coffee", image: "Coffee.jpg", preparationTime: 7, tags: ["coffee", "nutty"], modifiers: [], addons: [{ name: "Add Double Shot", price: 25 }] },
